...
export default {
  ...
  props: {
    ...
    //       })
		...
		return {router, participants, connect, state, register, sendMessage, onParticipantLeft, receiveVideo,onExistingParticipants, callResponse, Participant, leaveRoom}
		},
}
</script>
